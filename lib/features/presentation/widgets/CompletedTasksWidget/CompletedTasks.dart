...
import 'package:untitled/features/presentation/widgets/buildTaskItemWidget/ItembuilderUnCompleted.dart';
        ...
        return Column(
            children:[ Expanded(
              child: ListView.separated(
                itemBuilder: (context, index) => buildTaskUncompletedItem(cubit[index], context),
